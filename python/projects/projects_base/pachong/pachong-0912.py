...
class DbTest:
    ...
    def saveResultINexcel(self,datest):
        ...
        file = 'F:/tuofu2017/learn/Python/files/results.xls';
        wb = Workbook()
        ws = wb.worksheets[0];
        ws.append(headers);
...
if __name__ == '__main__':
    ...
    datest=DbTest();
    datest.getWebsitesByExcel("F:/tuofu2017/learn/Python/files/网址.xls");
    ...
    while x==1:
        if datest.allurlsforlevel.__len__()==0:
            if y==0:
               time.sleep(10)
            y=1;
            if datest.allurlsforlevel.__len__() == 0 and datest.existurlbrands.__len__()==datest.allurls.__len__():
